...
actor MetadataCache {
    ...
    func load(for key: MetadataCacheKey) -> MetadataCacheRecord? {
        loadIndexIfNeeded()
    ...
    func save(_ record: MetadataCacheRecord) async throws -> MetadataCacheRecord {
        loadIndexIfNeeded()
    ...
    func downloadImage(from remoteURL: URL, to destination: URL) async throws {
