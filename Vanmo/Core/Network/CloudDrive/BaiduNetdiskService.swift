...
final class BaiduNetdiskService: RemoteFileService {
    static let requiredUserAgent = "pan.baidu.com"

    let type: ConnectionType = .baiduNetdisk
    ...
    static func directoryPath(from path: String) -> String {
    ...
    static func fsId(from path: String) throws -> Int64 {
        let trimmed = path.trimmingCharacters(in: .whitespacesAndNewlines)
