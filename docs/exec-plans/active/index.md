...
- [`2026-08-26-debug-build-evidence-layer.md`](2026-08-26-debug-build-evidence-layer.md) — **Implemented.** Layered Debug compile evidence exists; the first matrix is red because iOS still lacks the `.paused` settings branch.
