...
public final class JellyfinService: MediaServerService, MediaSearchProviding {
    private let inner: EmbyService

    public var type: ConnectionType { inner.type }
    public var isConnected: Bool { inner.isConnected }
    ...
    public func searchMedia(query: String, limit: Int) async throws -> [ServerMediaItem] {
