...
public actor MetadataRefreshCoordinator {
    public static let shared = MetadataRefreshCoordinator()

    private let cache = MetadataCache.shared

    nonisolated public static func supportsRefresh(for item: MediaItem) -> Bool {
...
public enum MetadataRefreshError: LocalizedError {
