...
public final class SRTParser: SubtitleParser {
    public func parse(data: Data, encoding: String.Encoding? = nil) throws -> [SubtitleCue] {
    ...
    public func parse(string: String) throws -> [SubtitleCue] {
