...
public enum DynamicRange: String {
    case sdr
    ...
    /// 列表角标用的紧凑标签。
    public var compactBadge: String? {
        switch self {
        case .sdr: return nil
        case .hdr: return "HDR"
        case .hdr10: return "HDR10"
...
public enum PlayerCapabilityProbe {
    public static func isHDRCandidate(url: URL) -> Bool {
    ...
    public static func isDiscImage(url: URL) -> Bool {
    ...
    public static func detectDynamicRange(for url: URL) async -> DynamicRange? {
