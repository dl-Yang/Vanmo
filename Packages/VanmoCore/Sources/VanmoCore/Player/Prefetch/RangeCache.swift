...
public final class RangeCache {
    ...
    public func chunkIndex(forGlobalOffset offset: Int64) -> Int {
        Int(offset / Int64(chunkSize))
    }

    public func hasEntire(range: Range<Int64>) -> Bool {
        lock.lock()
        defer { lock.unlock() }
    ...
    public func readEntire(range: Range<Int64>) -> Data? {
        lock.lock()
        defer { lock.unlock() }
    ...
    public func write(globalOffset: Int64, data: Data) {
